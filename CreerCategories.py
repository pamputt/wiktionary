...
def createCategoryLexiqueAdministration(page,cle):
  #Catégorie:Lexique en italien de l’administration
  language = guessLanguage(page,"en","de l’",cle)
  if not language:
    return
  
  wikitext = "[[Catégorie:Lexiques en " + language + "|administration]]\n"
  wikitext += "[[Catégorie:Administration|" + cle[language] + "]]"
  return wikitext
...
def createCategoryLexiqueArchitecture(page,cle):
  #Catégorie:Lexique en italien de l’architecture
  language = guessLanguage(page,"en","de l’",cle)
  if not language:
    return
...
def createCategoryLexiqueArmement(page,cle):
  #Catégorie:Lexique en italien de l’armement
  language = guessLanguage(page,"en","de l’",cle)
  if not language:
    return
  
  wikitext = "[[Catégorie:Lexique en " + language + " du militaire|armement]]\n"
  wikitext += "[[Catégorie:Armement|" + cle[language] + "]]"
  return wikitext
...
def createCategoryLexiqueAutomatique(page,cle):
  #Catégorie:Lexique en anglais de l’automatique
  language = guessLanguage(page,"en","de l’",cle)
  if not language:
    return
  
  wikitext = "[[Catégorie:Lexique en " + language + " de la technique|automatique]]\n"
  wikitext += "[[Catégorie:Automatique|" + cle[language] + "]]"
  return wikitext
...
def createCategoryLexiqueBoucherie(page,cle):
  #Catégorie:Lexique en italien de la boucherie
  language = guessLanguage(page,"en","de la",cle)
  if not language:
    return
  
  wikitext = "[[Catégorie:Lexique en " + language + " de la cuisine|boucherie]]\n"
  wikitext += "[[Catégorie:Boucherie|" + cle[language] + "]]"
  return wikitext
...
def createCategoryLexiqueCirque(page,cle):
  #Catégorie:Lexique en français du cirque
  language = guessLanguage(page,"en","du",cle)
  if not language:
    return
  
  wikitext = "[[Catégorie:Lexiques en " + language + "|cirque]]\n"
  wikitext += "[[Catégorie:Cirque|" + cle[language] + "]]"
  return wikitext
...
def createCategoryLexiqueForesterie(page,cle):
  #Catégorie:Lexique en italien de la foresterie
  language = guessLanguage(page,"en","de la",cle)
  if not language:
    return
  
  wikitext = "[[Catégorie:Lexiques en " + language + "|foresterie]]\n"
  wikitext += "[[Catégorie:Foresterie|" + cle[language] + "]]"
  return wikitext
...
def createCategoryLexiqueGlaciologie(page,cle):
  #Catégorie:Lexique en italien de la glaciologie
  language = guessLanguage(page,"en","de la",cle)
  if not language:
    return
  
  wikitext = "[[Catégorie:Lexique en " + language + " des sciences|glaciologie]]\n"
  wikitext += "[[Catégorie:Lexiques en " + language + "|glaciologie]]\n"
  wikitext += "[[Catégorie:Glaciologie|" + cle[language] + "]]"
  return wikitext
...
def createCategoryLexiqueHeraldique(page,cle):
  #Catégorie:Lexique en italien de l’héraldique
  language = guessLanguage(page,"en","de l’",cle)
  if not language:
    return
  
  wikitext = "[[Catégorie:Lexiques en " + language + "|heraldique]]\n"
  wikitext += "[[Catégorie:Héraldique|" + cle[language] + "]]"
  return wikitext
...
def createCategoryLexiqueHockeyGlace(page,cle):
  #Catégorie:Lexique en anglais du hockey sur glace
  language = guessLanguage(page,"en","du",cle)
  if not language:
    return
  
  wikitext = "[[Catégorie:Lexique en " + language + " des sports d’hiver|hockey sur glace]]\n"
  wikitext += "[[Catégorie:Lexique en " + language + " du hockey|hockey sur glace]]\n"
  wikitext += "[[Catégorie:Hockey sur glace|" + cle[language] + "]]"
  return wikitext
...
def createCategoryLexiqueHygiene(page,cle):
  #Catégorie:Lexique en français de l’hygiène
  language = guessLanguage(page,"en","de l’",cle)
  if not language:
    return
  
  wikitext = "[[Catégorie:Lexique en " + language + " de la santé|hygiene]]\n"
  wikitext += "[[Catégorie:Hygiène|" + cle[language] + "]]"
  return wikitext
...
def createCategoryLexiqueLangageJava(page,cle):
  #Catégorie:Lexique en français du langage Java
  language = guessLanguage(page,"en","du",cle)
  if not language:
    return
  
  wikitext = "[[Catégorie:Lexique en " + language + " de la programmation orientée objet|java]]\n"
  wikitext += "[[Catégorie:Langage Java|" + cle[language] + "]]"
  return wikitext
...
def createCategoryLexiqueMedecineVeterinaire(page,cle):
  #Catégorie:Lexique en italien de la médecine vétérinaire
  language = guessLanguage(page,"en","de la",cle)
  if not language:
    return
  
  wikitext = "[[Catégorie:Lexiques en " + language + "|medecine]]\n"
  wikitext += "[[Catégorie:Lexique en " + language + " de la zoologie|veterinaire]]\n"
  wikitext += "[[Catégorie:Médecine vétérinaire|" + cle[language] + "]]"
  return wikitext
...
def createCategoryLexiqueProgrammationOrienteeObjet(page,cle):
  #Catégorie:Lexique en anglais de la programmation orientée objet
  language = guessLanguage(page,"en","de la",cle)
  if not language:
    return
  
  wikitext = "[[Catégorie:Lexique en " + language + " de la programmation]]\n"
  wikitext += "[[Catégorie:Programmation orientée objet|" + cle[language] + "]]"
  return wikitext
...
def createCategoryLexiqueSculpture(page,cle):
  #Catégorie:Lexique en italien de la sculpture
  language = guessLanguage(page,"en","de la",cle)
  if not language:
    return
  
  wikitext = "[[Catégorie:Lexique en " + language + " de l’art|sculpture]]\n"
  wikitext += "[[Catégorie:Lexiques en " + language + "|sculpture]]\n"
  wikitext += "[[Catégorie:Sculpture|" + cle[language] + "]]"
  return wikitext
...
def createCategoryLexiqueSportsDeCombat(page,cle):
  #Catégorie:Lexique en italien des sports de combat
  language = guessLanguage(page,"en","des",cle)
  if not language:
    return
  
  wikitext = "[[Catégorie:Lexique en " + language + " du sport|sport de combat]]\n"
  wikitext += "[[Catégorie:Lexiques en " + language + "|combat]]\n"
  wikitext += "[[Catégorie:Sport de combat|" + cle[language] + "]]"
  return wikitext
...
def createCategory(page,cle,code,country):  
  ...
  if (page.find("Catégorie:Prononciations audio en") != -1):
    ...
    wikitext = createCategoryLexiqueHockey(page,cle)
        ...
        (page.find(" du hockey sur glace") != -1)):
    wikitext = createCategoryLexiqueHockeyGlace(page,cle)
  elif ((page.find("Catégorie:Lexique en ") != -1) and
    ...
    wikitext = createCategoryLexiqueMedecine(page,cle)
        ...
        (page.find(" de la médecine vétérinaire") != -1)):
    wikitext = createCategoryLexiqueMedecineVeterinaire(page,cle)
  elif ((page.find("Catégorie:Lexique en ") != -1) and
        (page.find(" de la programmation orientée objet") != -1)):
    wikitext = createCategoryLexiqueProgrammationOrienteeObjet(page,cle)
  elif ((page.find("Catégorie:Lexique en ") != -1) and
    ...
    wikitext = createCategoryLexiqueHydrologie(page,cle)
        ...
        (page.find(" de l’hygiène") != -1)):
    wikitext = createCategoryLexiqueHygiene(page,cle)
  elif ((page.find("Catégorie:Lexique en ") != -1) and
    ...
    wikitext = createCategoryLexiqueSport(page,cle)
        ...
        (page.find(" des sports de combat") != -1)):
    wikitext = createCategoryLexiqueSportsDeCombat(page,cle)
  elif ((page.find("Catégorie:Lexique en ") != -1) and
    ...
    wikitext = createCategoryLexiqueAlpinisme(page,cle)
        ...
        (page.find(" de l’administration") != -1)):
    wikitext = createCategoryLexiqueAdministration(page,cle)
  elif ((page.find("Catégorie:Lexique en ") != -1) and
        (page.find(" de l’automatique") != -1)):
    wikitext = createCategoryLexiqueAutomatique(page,cle)
  elif ((page.find("Catégorie:Lexique en ") != -1) and
        (page.find(" de la glaciologie") != -1)):
    wikitext = createCategoryLexiqueGlaciologie(page,cle)
  elif ((page.find("Catégorie:Lexique en ") != -1) and
        (page.find(" du langage Java") != -1)):
    wikitext = createCategoryLexiqueLangageJava(page,cle)
  elif ((page.find("Catégorie:Lexique en ") != -1) and
    ...
    wikitext = createCategoryLexiqueNutrition(page,cle)
        ...
        (page.find(" de la sculpture") != -1)):
    wikitext = createCategoryLexiqueSculpture(page,cle)
  elif ((page.find("Catégorie:Lexique en ") != -1) and
    ...
    wikitext = createCategoryLexiqueSystemesElectoraux(page,cle)
        ...
        (page.find(" de l’architecture") != -1)):
    wikitext = createCategoryLexiqueArchitecture(page,cle)
  elif ((page.find("Catégorie:Lexique en ") != -1) and
        (page.find(" de l’armement") != -1)):
    wikitext = createCategoryLexiqueArmement(page,cle)
  elif ((page.find("Catégorie:Lexique en ") != -1) and
        (page.find(" de la boucherie") != -1)):
    wikitext = createCategoryLexiqueBoucherie(page,cle)
  elif ((page.find("Catégorie:Lexique en ") != -1) and
        (page.find(" du cirque") != -1)):
    wikitext = createCategoryLexiqueCirque(page,cle)
  elif ((page.find("Catégorie:Lexique en ") != -1) and
        (page.find(" de la foresterie") != -1)):
    wikitext = createCategoryLexiqueForesterie(page,cle)
  elif ((page.find("Catégorie:Lexique en ") != -1) and
        (page.find(" de l’héraldique") != -1)):
    wikitext = createCategoryLexiqueHeraldique(page,cle)
...
def main():
  ...
  if test:
    createCategory("[[:Catégorie:Régions de l’Inde en anglais]]", cle, codeLangue, continentByCountryDict)
    createCategory("[[:Catégorie:Régions de France en japonais]]", cle, codeLangue, continentByCountryDict)
    createCategory("[[:Catégorie:Régions d’Europe en coréen]]", cle, codeLangue, continentByCountryDict)
